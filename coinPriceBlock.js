!(function (e) {
  ...
  function (e, t, n) {
    ...
    t.a = {
      ...
      eur: { id: 2790, name: "Euro", symbol: "eur", token: "鈧�", space: "" },
      gel: {
        id: 3539,
        name: "Georgian Lari",
        symbol: "gel",
    ...
    function s(e, t) {
      for (var n = {}, r = [], o = 0; o < e.length; o++) {
        ...
        -1 !== p
          ...
          : a.push({ identifier: l, updater: C(d, t), references: 1 }),
          r.push(l);
      }
      return r;
    }
  ...
  function (e, t) {
    ...
    function d() {
      l &&
        s &&
        ((l = !1), s.length ? (u = s.concat(u)) : (p = -1), u.length && f());
    }
    function f() {
      if (!l) {
        var e = c(d);
  ...
  function (e, t, n) {
    ...
    var r = n(2),
      ...
      m = function (e, t, n) {
        for (
          var r = document.createDocumentFragment(), o = 0;
          o < e.length;
          o++
        ) {
          var i = e[o],
      ...
      h = function (e, t, n) {
        ...
        var p = n
          ...
          d = "\n    "
            ...
            .concat(
              c > 0
                ? "coinPriceBlock__changes--up"
                : "coinPriceBlock__changes--down",
      ...
      r.setAttribute("id", "coinPriceBlock-wrapper"),
        r.setAttribute(
          ...
          "coinPriceBlock-wrapper "
            .concat(
              n ? "coinPriceBlock-wrapper--transparent" : "",
              " coinPriceBlock-wrapper--"
            )
            .concat(t)
        );
